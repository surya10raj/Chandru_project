...
function showNegative(plant) {
    ...
    switch(plant) {
        case "cotton":
            resultDiv.innerHTML = `
                <h3>Fusarium wilt - Fusarium oxysporum f.sp. vasinfectum</h3>
                <h4>Treatment</h4>
                <ul>
                ...
                <h3>Verticillium wilt - Verticillium dahliae</h3>
                <h4>Treatment</h4>
                <ul>
                    <li>Remove and burn the infected plant debris in the soil after deep summer ploughing.</li>
                    <li>Apply farm yard manure or other organic manures @ 4 t/ac.</li>
        ...
        case "rubber":
            resultDiv.innerHTML = `
                <h3>Abnormal leaf fall - Phytophthora palmivora & P. nicotianae var. parasitica</h3>
                <h4>Treatment</h4>
                <ul>
...
function negativeResult() {
    ...
    <ul>
        <li><strong>Stem rot - Macrophomina phaseolina:</strong> Collection of healthy seeds from the infection-free area, crop rotation with paddy, spraying fungicide before sowing seedlings, application of stem rot disease variety, early harvesting.</li>
        <li><strong>Anthracnose - Colletotrichum corchorii:</strong> Control involves growing resistant varieties and rust-free plants, destroying alternate host plants, observing stringent sanitation measures, and using appropriate fungicides like copper sprays containing copper diammonia diacetate (e.g., Liquicop), propiconazole (e.g., Banner Maxx II), and the systemic fungicide thiophanate-methyl.</li>
        <li><strong>Blackband - Botryodiplodia theobromae:</strong> Clean cultivation, seed treatment with Carbendazim 50 WP @ 2g/kg and foliar application of Carbendazim 50 WP @ 2g/l water or Cu-oxychloride @ 5-7 g/l water or Mancozeb @ 4-5 g/l water provides effective management.</li>
        <li><strong>Soft rot - Sclerotium rolfsii:</strong> Burning the infected plant, deep ploughing of the soil, soil treatment, foliar spray of fungicide.</li>
    </ul>
    `;
}
