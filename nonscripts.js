...
function showNegative(plant) {
    ...
    switch(plant) {
        ...
        case "rubber":
            resultDiv.innerHTML = `
            <img src="./Abnormal leaf fall.jpg" alt="White Clover Mosaic" width=70px height=70px><br>
...
function negativeResultjute() {
    ...
    <ul>
    <img src="./Stem rot.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Botryodiplodia theobromae.png" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Soft rot.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
...
function negativeResult() {
    ...
    <h3>Negative Aspects</h3>
    <ul>
    <img src="./Damping off.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Frog eye leaf spot.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Black shank.jpg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Rhizoctonia solani.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Alternaria alternata.jpg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Tobacco mosaic.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Leaf curl.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
        ...
        <img src="./Broom rape.jpeg" alt="White Clover Mosaic" width=70px height=70px><br>
