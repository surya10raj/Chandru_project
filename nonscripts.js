...
function positiveResult(){
    ...
    <ul>
        <li>Jute - <em>Endophytes</em>: Growth promoting by the production of phytohormones</li>
        <li>Jute - <em>Klebsiella</em>: Nitrogen Fixation</li>
        <li>Jute - <em>Staphylococcus saprophyticus</em>: Prevent diseases</li>
    </ul>
    ` ;
}
