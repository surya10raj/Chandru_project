...
function negativeResult() {
    ...
    <strong>Rice Blast - <em>Magnaporthe grisea</em>:</strong>
        ...
        <img src="./Sheath Rot Of Rice.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Rice Brown Spot.jpeg" alt="White Clover Mosaic"><br>
        <strong>Rice Brown Spot - <em>Helminthosporium oryzae</em>:</strong>Fungicides like iprodione, propiconazole, azoxystrobin, trifloxystrobin, and carbendazim can be used as seed treatments. Hot water treatment before planting can also help control primary infection.<br>
         ...
         <img src="./False Smut Of Rice.jpg" alt="White Clover Mosaic"><br>
         ...
         <img src="./Sheath Blight Of Rice.jpeg" alt="White Clover Mosaic"><br>
         ...
         <img src="./Tungro Disease Of Rice.jpg" alt="White Clover Mosaic"><br>
         ...
         <img src="./Foolish Seedling Disease.jpg" alt="White Clover Mosaic"><br>
         ...
         <img src="./Stem Rot Of Rice.jpeg" alt="White Clover Mosaic"><br>
         ...
         <img src="./Grassy Stunt Disease Of Rice.jpeg" alt="White Clover Mosaic"><br>
...
function showNegativeResult() {
    document.getElementById("result").style.display = "block";
    document.getElementById("result").innerHTML = `
    <img src="./Black or Stem Rust.jpg" alt="White Clover Mosaic"><br>
...
<br>
    This is a fungal disease that affects cereal crops. Fungicides like azoxystrobin and cyproconazole can help reduce its impact.<br>
        ...
        <img src="./Brown or Leaf Rust.jpeg" alt="White Clover Mosaic"><br>
...
<br>
        ...
        <img src="./Yellow or Stripe Rust.jpeg" alt="White Clover Mosaic"><br>
...
This rust disease affects cereals as well. Control measures include mixed cropping, avoiding excess nitrogenous fertilizers, and using fungicides like Zineb or Propioconazole. <br>
        ...
        <img src="./Loose Smut.png" alt="White Clover Mosaic"><br>
...
<br>
 A disease affecting cereals caused by a fungus, it can be controlled by treating seeds with Vitavax before sowing and burying infected ear heads in the soil to prevent further spread.<br>
        ...
        <img src="./Flag Smut.jpeg" alt="White Clover Mosaic"><br>
...
This disease can be controlled by treating seeds with carboxin, a fungicide.<br>
         ...
         <img src="./Hill Bunt or Stinking Smut.jpg" alt="White Clover Mosaic"><br>
...
Treat seeds with carboxin or carbendazim, grow during high-temperature periods, and adopt shallow sowing to manage this disease.<br>
        ...
        <img src="./Karnal Bunt.jpg" alt="White Clover Mosaic"><br>
...
This disease affects wheat and can be managed through good hygiene practices and delaying the drilling of a second wheat crop after harvesting an infected wheat crop.<br>
         ...
         <img src="./Fusarium Head Blight.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Fusarium graminearum.jpg" alt="White Clover Mosaic"><br>
...
<br>
 Manage this disease by following crop rotation practices and treating seeds with Carboxin or Carbendazim.<br>
        ...
        <img src="./Powdery Mildew.jpeg" alt="White Clover Mosaic"><br>
...
<br>
 A fungal disease affecting a wide range of plants, it can be controlled by spraying the crop with Wettable Sulphur or Carbendazim.<br>
         ...
         <img src="./Leaf Blight.jpg" alt="White Clover Mosaic"><br>
...
function negativeResultMaize() {
    document.getElementById("resultmaize").style.display = "block";
    document.getElementById("resultmaize").innerHTML = `
    <img src="./Downy mildew.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Puccinia sorghi.jpg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Turcicum blight.jpg" alt="White Clover Mosaic"><br>
...
function negativeResultFieldMustard() {
    ...
    <img src="./Bacterial black rot.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Albugo candida.jpg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Sclerotinia White Mould.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Aster Yellows.jpeg" alt="White Clover Mosaic"><br>
...
function negativeResultCucumber() {
    document.getElementById("resultcucumber").style.display = "block";
    document.getElementById("resultcucumber").innerHTML = `
    <img src="./Angular Leaf Spot.jpg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Bacterial Wilt.jpeg" alt="White Clover Mosaic"><br>
        ...
        <img src="./Phytophthora Crown And Root Rot.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Anthracnose.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Alternaria leaf spot.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Fusarium Wilt.jpg" alt="White Clover Mosaic"><br>
...
<img src="./Bud Necrosis disease.jpg" alt="White Clover Mosaic"><br>
...
<img src="./Guava Wilt.png" alt="White Clover Mosaic"><br>
...
<img src="./Puccinia psidii.jpg" alt="White Clover Mosaic"><br>
...
<img src="./Root-Knot Nematodes.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Gray Mold.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Mycospharella fragariae.jpg" alt="White Clover Mosaic"><br>
...
<img src="./Verticillium Wilt.jpg" alt="White Clover Mosaic"><br>
...
<img src="./Alternaria Fruit Spot.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Soft rot or rhizome rot.jpeg" alt="White Clover Mosaic"><br>
...
<img src="./Phyllosticta zingiberi.jpg" alt="White Clover Mosaic"><br>
